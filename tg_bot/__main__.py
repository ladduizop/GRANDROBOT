...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
Mai hu Laddu group managment bot aur mai 
aapke group ko acchese manage krunga ye wada 
hai mera , Madad ke liye type /help.
"""
...
TECHNO_IMG = "https://telegra.ph/file/d81e88a11f0d39a76664a.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="🧑‍💻Mera maalik🧑‍💻",
                                                                       url="t.me/laddu_iz_op")],
                                                                                   [InlineKeyboardButton(text="Laddu manager bot ko apne group me add kare",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/ladduizop/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Haa sir/mam Mai zinda hu")
